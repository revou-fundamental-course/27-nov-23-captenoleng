function hitungLuas() {
	...
	if (alas && tinggi != 0) {
		...
		document.getElementById("kalmatLuas").innerHTML = "Luas = alas * tinggi / 2";
		document.getElementById("penjabaranLuas").innerHTML = "Luas = " + alas + " * " + tinggi + " / 2";
...
function hitungKeliling() {
	...
	if (sisi_alas && miring1 && miring2 != 0) {
		...
		document.getElementById("kalmatKeliling").innerHTML = "Keliling = sisi alas + sisi miring 1 + sisi miring 2";
		document.getElementById("penjabaranKeliling").innerHTML = "Keliling = " + sisi_alas + " + " + miring1 + " + " + miring2 + " = " + hasilKeliling;
		document.getElementById("kalKeliling").innerHTML = "Keliling = " + hasilKeliling;
		event.preventDefault();
	} else {
		alert('Nilai yang dimasukkan tidak sesuai');
		event.preventDefault();
